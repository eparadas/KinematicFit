...
int main(int argc, char* argv[])
{
	...
	sprintf(outputroot, "vkinematicfit_test__%d.root", num_file);
	sprintf(outputtxt, "vkinematicfit_test_%d.txt", num_file);
...
//      ofstream out("chi_values.txt");
	...
	float Corrections[9];
	int best_combination_mkf[8], best_combination_mkf_temp[8], evt, Converged_mkf_[2];
	...
	outTree->Branch("event_mkf", &evt, "evt/I");
